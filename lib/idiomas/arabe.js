...
const smsAvisoMG = () => { return `╰⊱❗️⊱ غلط كده يا حب ⊱❗️⊱╮\n\n` }
...
//_allantilink.js
const smsTextoYT = () => { return 'Zenon↳🐢↲𝐁𝐎𝐓'}
...
const smsBCbot7 = () => { return `✅ * رساله من المطور* ✅`}

//propietario(a).js
const smsChatGP1 = () => { return "*أرسل رسالة ، انتظر لحظة...*"}
const smsChatGP2 = (readMS, dia, mes, año, fecha, tiempo) => { return `✅ *رساله من المطور* ✅\n${readMS}\n\`\`\`${dia}, ${mes} ${año}\`\`\`\n\`\`\`${fecha} || ${tiempo}\`\`\`\n\n`}
